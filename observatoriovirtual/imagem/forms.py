...
class WaveletForm(forms.Form):
    ...
    Method = forms.ChoiceField(label=mark_safe("<a href='http://scikit-image.org/docs/dev/api/skimage.restoration.html#denoise-wavelet'>Método</a>"), choices=(("visushrink", "VisuShrink"), ("bayeshrink", "BayesShrink")))
